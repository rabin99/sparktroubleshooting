- # Shuffle 过程
  ...
  **从实现角度来看，两者也有不少差别。** Hadoop MapReduce 将处理流程划分出明显的几个阶段：map(), spill, merge, shuffle, sort, reduce() 等。每个阶段各司其职，可以按照过程式的编程思想来逐一实现每个阶段的功能。在 Spark 中，没有这样功能明确的阶段，只有不同的 stage 和一系列的 transformation()，所以 spill, merge, aggregate 等操作需要蕴含在 transformation() 中。
  ...
  [![shuffle-write-no-consolidation](assets/shuffle-write-no-consolidation.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/shuffle-write-no-consolidation.png)
  ...
  [![shuffle-write-consolidation](assets/shuffle-write-consolidation.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/shuffle-write-consolidation.png)
  ...
  [![reduceByKey](assets/reduceByKeyStage.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/reduceByKeyStage.png)
  ...
  [![shuffle-reduce](assets/reduceByKeyRecord.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/reduceByKeyRecord.png)
  ...
  **从内存利用上来对比：**
  ...
  [![ShuffleGroupByKey](assets/ShuffleGroupByKey.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/ShuffleGroupByKey.png)
  ...
  [![ShuffleDistinct](assets/ShuffleDistinct.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/ShuffleDistinct.png)
  ...
  [![ShuffleCoGroup](assets/ShuffleCoGroup.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/ShuffleCoGroup.png)
  ...
  [![intersection](assets/ShuffleIntersection.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/ShuffleIntersection.png)

  [![join](assets/ShuffleJoin.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/ShuffleJoin.png)这两个操作中均使用了 cogroup，所以 shuffle 的处理方式与 cogroup 一样。

  ### 6. sortByKey(ascending, numPartitions)

  [![sortByKey](assets/ShuffleSortByKey.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/ShuffleSortByKey.png)
  ...
  [![Coalesce](assets/ShuffleCoalesce.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/ShuffleCoalesce.png)
  ...
  [![AppendOnlyMap](assets/appendonlymap-1545202036864.png)](https://github.com/JerryLead/SparkInternals/blob/master/markdown/PNGfigures/appendonlymap.png)
